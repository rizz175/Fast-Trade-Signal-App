...
class ClosedsignalPage extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    return _ClosedsignalPageState();
  }
}

class _ClosedsignalPageState extends State<ClosedsignalPage>{
...
bool isloading=false;
  ...
  Future<void> _fetchData() async {
    ...
    const API_URL = 'https://appadmin1.xyz/api/get/closed';
          ...
          child: SafeArea(
              child: _loadedPhotos.length == 0
                ...
                child: ElevatedButton(
                  child: Text('Browse Closed Signals'),
                  ...
                  return Card(
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTile(
                            title: Text('${_loadedPhotos[index]["symbol"]}'),
