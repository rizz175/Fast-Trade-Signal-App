...
class TmessagePage extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    return _TmessagePageState();
  }
}

class _TmessagePageState extends State<TmessagePage>{
...
setState(() {
  isloading=true;
    ...
    String API_URL = 'https://appadmin1.xyz/api/get/tmessages';
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Ink.image(
                              image: NetworkImage(
                                  'https://appadmin1.xyz/public/messages/'+_loadedPhotos[index]["msg_img"]),
                              fit: BoxFit.cover,
                            ),
                          ),
                          Container(
