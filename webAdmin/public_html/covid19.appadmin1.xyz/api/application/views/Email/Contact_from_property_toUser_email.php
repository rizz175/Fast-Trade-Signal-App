					...
					<table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-color:#E5E5E5; border-style:solid; border-width:0 1px 1px 1px;" width="100%" class="tableCard">
						...
						<tr>
							<td align="center" valign="top" style="padding-left:20px;padding-right:20px;" class="containtTable ui-sortable">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
									<tbody><tr>
										<td align="center" valign="top" style="padding-bottom: 10px;padding-top: 30px;" class="description">
                                            ...
                                            <!-- Description Text// -->
											<p class="text" style="color:#000; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:600; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
												Below is the property you're interested!
											</p>
										</td>
									</tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
									<tbody><tr>
										<td align="center" valign="top" style="padding-bottom: 0px;padding-top: 0px;" class="description">
                                            ...
                                            <a class="text" href="<?=$data2['property_url']?>" target="_blank" style="text-decoration:none; display:block;">
											<img src="<?=$data2['prop_img']?>">
											...
											<p class="text" style="color:#000; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; padding-bottom:10px; margin:0">
												<?=$data2['currency']." ".number_format($data2['price'])?>
											</p>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="background:#f3f5fa;padding-left:10px;padding-right:10px;padding-top:10px;">
									<tbody>
                                     ...
                                     <tr>
										<td align="center" valign="top" style="padding-left: 0px;padding-right: 0px;padding-bottom:10px;" class="description">
                                            ...
                                            <!-- Description Text// -->
											<p class="text" style="color:#000; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0; text-decoration:underline;">
												Below is your details and message!
											</p>
                                        </td>
                               ...
                               <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="background:#f3f5fa;padding-left:10px;padding-right:10px;padding-top:0px;">
                                    ...
                                    <tr>
										...
										<td align="left" valign="middle" style="padding-left: 5px;padding-right: 5px;background:#fff;" class="description">
                                            ...
                                            <!-- Description Text// -->
											<p class="text" style="color:#000; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
												+<?=$data1['mobile_code']."-".$data1['mobile']?>
											</p>
                                        ...
                                        <td align="right" valign="top" style="padding-top: 5px;padding-right: 5px;background:#fff;" class="description">
                                        <img src="<?=$this->config->item("main_url")?>assets/img/user-img.png" height="65">
									...
									<tbody>
                                    <tr>
										<td align="center" valign="top" style="padding-bottom: 10px;padding-top: 10px;" class="description">
											<!-- Description Text// -->
											<p class="text" style="color:#000; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:justify; padding:0; margin:0">
												<span style="font-weight:600;"><b>Message:</b></span> <?=$data1['message']?>
											</p>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
                                    ...
                                    <tr>
										<td align="center" valign="top" style="padding-bottom: 5px;padding-top: 20px;" class="description">
											<!-- Description Text// -->
										...
										<td align="center" valign="top" style="padding-top:30px;padding-bottom:20px;">
											...
											<table align="center" border="0" cellpadding="0" cellspacing="0">
												<tbody><tr>
													<td align="center">
														<!-- Button Link // -->
														<a class="text" href="<?=$data2['agent_url']?>" target="_blank" style="text-decoration:none; display:block; width:100px; height:100px;">
															<img src="<?=$data2['profile_pic']?>" height="100">
														</a>
                                                        
                                                        <a class="text" href="<?=$data2['agent_url']?>" target="_blank" style="color:#000; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:14px; font-weight:600; font-style:normal; line-height:21px; text-decoration:none; display:block;">
															<b><?=$data2['user_name']?></b>
														</a>
											...
											<table align="center" border="0" cellpadding="0" cellspacing="0">
												<tbody><tr>
													<td align="center" class="ctaButton" style="border: 2px solid #f00005;background: #fff;padding: 12px 35px;">
														<!-- Button Link // -->
														<a class="text" href="tel:<?=$data2['user_mobile']?>" target="_blank" style="color:#000; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:14px; font-weight:600; font-style:normal; line-height:21px; text-decoration:none; display:block; width:250px;">
															<?=$data2['user_mobile']?>
														</a>
													</td>
												</tr>
										...
										<td align="center" valign="top" style="padding-top:10px;padding-bottom:0px;">
											...
											<table align="center" border="0" cellpadding="0" cellspacing="0">
												<tbody><tr>
													<td align="center" class="ctaButton" style="border: 2px solid #f00005;background: #fff;padding: 12px 35px;">
														<!-- Button Link // -->
														<a class="text" href="mailto:<?=$data2['user_email']?>" style="color:#000; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:14px; font-weight:600; font-style:normal; line-height:21px; text-decoration:none; display:block; width:250px;">
															Click to Email
														</a>
													</td>
												</tr>
