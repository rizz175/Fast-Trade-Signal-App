						...
						<tr>
							<td align="center" valign="top" style="padding-left:20px;padding-right:20px;" class="containtTable ui-sortable">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
									<tbody><tr>
										<td align="center" valign="top" style="padding-bottom: 0px;padding-top: 30px;" class="description">
											<!-- Description Text// -->
											...
											<p class="text" style="color:#000; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:600; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                            	...
                                            	<?php if(count($prop_arr)>1){ ?>
                                                
                                                Below are the properties you might be interested!
                                                
                                                <?php } else{ ?>
												
                                                Below is the property you might be interested!
                                ...
                                <?php if($prop_arr){ 
									  foreach($prop_arr as $prop){ if($prop){
								?>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
									<tbody><tr>
										<td align="center" valign="top" style="padding-bottom: 0px;padding-top: 20px;border-bottom:1px solid #ccc;" class="description">
                                        
                                            <a class="text" href="<?=$property_url.$prop['prop_id']."?view=list"?>" target="_blank" style="text-decoration:none; display:block;">
											<img src="<?=$prop['prop_img']?>">
											...
											<p class="text" style="color:#000; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; padding-bottom:0px; margin:0">
												<?=$prop['currency']." ".number_format($prop['price'])?>
											</p>
                                            
                                            <a class="text" href="<?=$property_url.$prop['prop_id']."?view=list"?>" target="_blank" style="text-decoration:underline; display:block;">
                                                <p class="text" style="color:#000FBF; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; padding-bottom:10px; margin:0">
                                                Visit Property
                                                </p>
                                            </a>
