			...
			<tbody><tr>
				<td align="center" valign="top">
					...
					<table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-color:#E5E5E5; border-style:solid; border-width:0 1px 1px 1px;" width="100%" class="tableCard">
						...
						<tbody><tr>
							<!-- Header Top Border // -->
							<td height="3" style="background-color:#0088cc;font-size:1px;line-height:3px;" class="topBorder">&nbsp;</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px;background: rgb(50, 136, 245);background: linear-gradient(110deg, rgb(126, 92, 241) 0%, rgb(50, 136, 245) 73%, rgb(1, 144, 248) 93%, rgb(1, 151, 248) 100%);" class="mainTitle">
								<!-- Main Title Text // -->
								<h2 class="text" style="color:#fff; font-family:&#39;Poppins&#39;, Helvetica, Arial, sans-serif; font-size:20px; font-weight:500; max-width:330px; font-style:normal; letter-spacing:normal; line-height:36px; text-transform:none; text-align:center; padding:0; margin:0">
									Hello <?php echo $name; ?>, below is the link for resetting the password.
								</h2>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-left:20px;padding-right:20px;" class="containtTable ui-sortable">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
									<tbody><tr>
										<td align="center" valign="top" style="padding-bottom: 20px;padding-top: 30px;" class="description">
											<!-- Description Text// -->
									...
									<tbody><tr>
										<td align="center" valign="top" style="padding-top:0px;padding-bottom:20px;">
											...
											<table align="center" border="0" cellpadding="0" cellspacing="0">
												<tbody><tr>
													<td align="center" class="ctaButton" style="background: rgb(50, 136, 245);border: 1px solid rgb(100, 168, 255);background: linear-gradient(110deg, rgb(192, 173, 255) 0%, rgb(122, 181, 255) 73%, rgb(55, 160, 237) 93%, rgb(126, 204, 255) 100%);padding: 12px 35px;border-radius: 50px;">
														<!-- Button Link // -->
														<a class="text" href="<?php echo @$url; ?>" target="_blank" style="color:#000; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:14px; font-weight:600; font-style:normal; line-height:21px; text-decoration:none; display:block">
															Reset Password
														</a>
													</td>
												</tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
                                    ...
                                    <tr>
										<td align="center" valign="top" style="padding-bottom: 5px;padding-top: 10px;" class="description">
											<!-- Description Text// -->
											<p class="text" style="color:#666666; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
												Reset Password URL:
											</p>
                                    ...
                                    <tr>
                                        <td align="center" valign="top">
                                         	<a class="text" href="<?php echo @$url; ?>" target="_blank" style="color:#0088cc; text-decoration:underline; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-style:normal; line-height:20px; text-transform:inherit; display:block">
                                                <?php echo @$url; ?>
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
									<tbody><tr>
										<td align="center" valign="top" style="padding-bottom: 0px;padding-top: 50px;" class="description">
											<!-- Description Text// -->
											<p class="text" style="color:#666666; font-family:&#39;Open Sans&#39;, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0;font-style:italic;">
