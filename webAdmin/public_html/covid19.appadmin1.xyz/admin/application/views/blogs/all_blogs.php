                          ...
                          <td>
                            <div class="dropdown btn-dropdown-div">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?=site_url("dashboard/blog/edit/").$row->id."/".$row->slug?>">Edit</a>
                                <a class="dropdown-item" onclick="return false;" href="#" @click="messagedeleteblog(<?=$row->id?>, '<?=$row->slug?>')">Delete</a>
                              </div>
                            </div>
                          </td>
                        </tr>
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">Delete this blog?</div>
                <div class="modal-footer">
                  <button class="btn btn-secondary" type="button" data-dismiss="modal">No</button>
                  <button class="btn btn-primary" @click="deleteblog" data-dismiss="modal">Yes</button>
                </div>
              </div>
            </div>
          </div>
...
new Vue({
  ...
  methods: {
    ...
    deleteblog() {
      ...
      window.location="<?=site_url("blog/delete/")?>"+this.blog_id+"/"+this.slug;
