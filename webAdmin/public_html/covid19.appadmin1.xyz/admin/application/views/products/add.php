...
const vm = new Vue({
  ...
  data() {
    return {
      p_img: "<?=site_url("assets/images")?>/default.jpg",
      image_file:null,
      description:"",
      title:"",
      price:"",
    ...
    submitForm(){
      ...
      if(this.validateForm()){
        ...
        for(single_img in this.images){
          ...
          formData.append('files['+single_img+']', this.images[single_img]);
        }
        ...
        axios.post( '<?=site_url("product/save")?>',
              formData,
              {
              headers: {
            ...
            if(d.data.status==200){
              window.location = "<?=site_url("dashboard/product/all")?>";
            }else{
